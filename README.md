...
<body>
  <div class="container">
    ...
    <div class="table-wrapper">
      <table id="checklist">
        <thead>
          <tr><th>モンスター名</th><th>狩猟数</th><th>☑</th><th>捕獲数</th><th>☑</th></tr>
        </thead>
        <tbody></tbody>
      </table>
    </div>
  ...
  <script>
    ...
    function render() {
      ...
      data.forEach((item, i) => {
        ...
        tdCapLabel.textContent = '捕獲数';
        const tdCap = document.createElement('td');
        const chC = document.createElement('input');
        chC.type = 'checkbox';
        chC.checked = item.captured;
        chC.onchange = () => {
          item.captured = chC.checked;
          save();
          updateProgress();
        };
